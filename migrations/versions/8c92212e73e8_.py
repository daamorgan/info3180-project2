...
Revision ID: 8c92212e73e8
Revises: 
Create Date: 2020-05-05 21:58:26.859183
...
def upgrade():
    ...
    sa.Column('joined_on', sa.String(length=255), nullable=True),
    ...
    sa.Column('follower_id', sa.Integer(), autoincrement=True, nullable=True),
